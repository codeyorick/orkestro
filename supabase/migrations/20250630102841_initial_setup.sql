...
create table "public"."piece_concerts"
(
    "id"         bigint generated by default as identity not null,
    "piece_id"   bigint                                  not null,
    "concert_id" bigint                                  not null,
    constraint "piece_concerts_pkey" primary key ("id"),
    constraint "piece_concerts_piece_id_fkey" foreign key ("piece_id") references "public"."pieces" ("id") on delete cascade,
    constraint "piece_concerts_concert_id_fkey" foreign key ("concert_id") references "public"."concerts" ("id") on delete cascade
);

create table "public"."piece_orchestras"
(
    "id"           bigint generated by default as identity not null,
    "piece_id"     bigint                                  not null,
    "orchestra_id" bigint                                  not null,
    constraint "piece_orchestras_pkey" primary key ("id"),
    constraint "piece_orchestras_piece_id_fkey" foreign key ("piece_id") references "public"."pieces" ("id") on delete cascade,
    constraint "piece_orchestras_orchestra_id_fkey" foreign key ("orchestra_id") references "public"."orchestras" ("id") on delete cascade
);

create table "public"."instrument_files"
(
    "id"            bigint generated by default as identity not null,
    "instrument_id" bigint                                  not null,
    "file_id"       bigint                                  not null,
    constraint "instrument_files_pkey" primary key ("id"),
    constraint "instrument_files_instrument_id_fkey" foreign key ("instrument_id") references "public"."instruments" ("id") on delete cascade,
    constraint "instrument_files_file_id_fkey" foreign key ("file_id") references "public"."files" ("id") on delete cascade
);

create table "public"."user_orchestra_instruments"
(
    "id"            bigint generated by default as identity not null,
    "instrument_id" bigint                                  not null,
    "orchestra_id"  bigint                                  not null,
    ...
    constraint "user_orchestra_instruments_instrument_id_fkey" foreign key ("instrument_id") references "public"."instruments" ("id") on delete cascade,
    constraint "user_orchestra_instruments_orchestra_id_fkey" foreign key ("orchestra_id") references "public"."orchestras" ("id") on delete cascade,
    constraint "user_orchestra_instruments_user_id_fkey" foreign key ("user_id") references "auth"."users" ("id") on delete cascade
);
...
alter table "public"."piece_concerts" enable row level security;
alter table "public"."piece_orchestras" enable row level security;
alter table "public"."files" enable row level security;
alter table "public"."instrument_files" enable row level security;
alter table "public"."user_orchestra_instruments" enable row level security;
...
policy "Give access if user has access to instrument" on "public"."instruments"
    for
select using (id in (select instrument_id from public.user_orchestra_instruments));

create
policy "Give access if user has access to instrument" on "public"."instrument_files"
    for
select using (instrument_id in (
    select user_orchestra_instruments.instrument_id
    from public.user_orchestra_instruments
    ));

create
policy "Give access if user has access to orchestra" on "public"."piece_orchestras"
    for
...
create
policy "Give access if user has access to concert" on "public"."piece_concerts"
    for
